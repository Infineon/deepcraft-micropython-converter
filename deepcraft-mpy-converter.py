...
def run_make():
    ...
    try:
        ...
        if process.returncode == 0:
            ...
            src_mpy_path = os.path.join("mpy", "examples", "natmod", "deepcraft", mpy_filename)
            dst_mpy_path = os.path.join(os.getcwd(), mpy_filename)
            mpy_folder = "mpy"
...
def clone_micropython_repo(repo_url, target_dir, branch, folders_to_clone):
    ...
    try:
        ...
        subprocess.run(["git", "sparse-checkout", "set"] + folders_to_clone, check=True)
